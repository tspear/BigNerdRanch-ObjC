...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // CGRectMake() creates a a CGRect from (x,y,width, height)
    ...
    // Create and configure the text field where the tasks will be typed
    ...
    // Buttons behave usign a target/action callback
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // first we check to see if theres a cell available for reuse
    ...
    // and hand back to the tableview the properly configured cell
    return c;
}
...
- (void)addTask:(id)sender
{
    ...
    // quit here if the texfield is empty
